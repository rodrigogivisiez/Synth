...
public:
    DrumMap(int sampleRate, int bufferSize, void (*fun)(CallBackJavaTypeMessage, int),
    ...
    void sendFxToLFO(string indexLfo, int indexChannel, int fxType, int keyEffectParam, int lfo1,
                     int lfo2, double start, double end, bool i4);
    ...
    void
    sendFxToControlXY(string basic_string, int i, int i1, int i2, int i3, double start, double end,
                      bool i5);
    ...
    void sendFxToADSR(int indexChannel, string mIndexControl, int fxType, int keyEffectParam,
                      double start, double end, bool i6);

    void
    sendFxToCurve(string indexString, int indexChannel, int curve, int fxType, int keyEffectParam,
                  double start, double end, bool i7);
