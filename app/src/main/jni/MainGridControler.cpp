...
bool MainGridControler::isNeedPlay(ChannelItem *channelItem) {
    return !channelItem->mIsPlay && channelItem->mStart <= mPositionBeat &&
           channelItem->mEnd > mPositionBeat;
}
...
MainGridControler::MainGridControler(int bufferSize, int sampleRate,
                                     MainGridControllerListener *listener) {
