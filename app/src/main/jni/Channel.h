...
public:
    ...
    void
    sendFxToLFO(string indexLfo, int fxType, int keyEffectParam, int lfo1, int lfo2, double start,
                double end, bool b2);

    void
    sendFxToADSR(string mIndexControl, int fxType, int keyEffectParam, double start, double end,
                 bool b1);

    void sendFxToCurve(string indexString, int curve, int fxType, int keyEffectParam, double start,
                       double end, bool b);
